# Raziel — flake output for the GrapheneOS Pixel.
#
...
{ self, inputs, ... }:
{
  flake.nixOnDroidConfigurations.raziel = inputs.nix-on-droid.lib.nixOnDroidConfiguration {
    pkgs = import inputs.nixpkgs { system = "aarch64-linux"; };
    modules = [ self.nixOnDroidModules.razielConfiguration ];
  };
}
