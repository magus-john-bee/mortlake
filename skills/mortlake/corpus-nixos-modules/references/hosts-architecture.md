...
- **sops**: `sopsLegacy.nix`
- **Host-specific persisted dirs**: `/var/lib/hermes`, `/var/lib/containers`, `/var/lib/acme`, `/var/lib/nginx`, `/home/john/.agentmemory`, `/home/john/.codex`
...
| AgentMemory | `/home/john/.agentmemory` | Vector store |
